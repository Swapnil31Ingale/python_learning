...
#     print(f"a. {question[1]}      b. {question[2]}")
#     print(f"c. {question[3]}      d. {question[4]}\n")
#     user_ans = input("Please select your answer from options (a-d) or q for quit:\n")

#     if user_ans.lower() == 'q':
#         fixed_money = money[i - 1] if i > 0 else 0
#         print("You have chosen to quit the Game, Best wishes for your future!!")
#         break

#     if user_ans.lower() not in ('a', 'b', 'c', 'd'):
#         print("Invalid answer, please select the correct answer from (a-d)")
#         break

#     if user_ans.lower() == chr(ord('a') + question[5] - 1):
#         print(f"Correct answer, You have won: {money[i]}\n")
#         if i == 4:
#             fixed_money = 10000
#         elif i == 9:
...
#             fixed_money = 10000000
#     else:
#         print(f"\nWrong answer, the correct answer is {chr(ord('a') + question[5] - 1)}.")
#         print(f"You will take Rs. {fixed_money} to home.")
#         break
